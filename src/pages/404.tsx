...
export function Error404() {
    return (
        <div className="flex flex-col justify-between items-center w-full">
            <img className="rounded-full mt-6" src="/assets/404.gif" alt="Página não encontrada" width={400} height={400}/>
            <h1 className="text-5xl md:text-7xl font-bold text-center text-[--text] mt-4">Uh oh.</h1>
